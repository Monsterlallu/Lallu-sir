...
if (conf.LANG == 'EN') {
    ...
    already_on = 'Lallusir artificial intelligence is already fully functional.'
    already_off = 'Lallusir artificial intelligence is currently running semi-functional.'
    succ_on = 'Lallusir Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Lallusir Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'AZ') {
